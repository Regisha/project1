...
class AdminerTheme
{
	...
	public function head()
	{
		...
		<link rel="icon" type="image/ico" href="php_admin/images/favicon.png">
		...
		?>
			...
			<meta name="msapplication-square150x150logo" content="php_admin/images/tileIcon.png"/>
		...
		<?php elseif (strpos($userAgent, "iPhone") !== false || strpos($userAgent, "iPad") !== false): ?>
			<link rel="apple-touch-icon-precomposed" href="php_admin/images/touchIcon.png"/>

		<?php elseif (strpos($userAgent, "Android") !== false): ?>
			<link rel="apple-touch-icon-precomposed" href="php_admin/images/touchIcon-android.png?3"/>

		<?php else: ?>
			<link rel="apple-touch-icon" href="images/touchIcon.png"/>
		<?php endif; ?>

		<link rel="stylesheet" type="text/css" href="php_admin/css/<?php echo htmlspecialchars($this->themeName) ?>.css?3">
